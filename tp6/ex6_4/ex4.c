...
int main() {
    char *ch1 = "coloc";
    int ans1, ans2;
    ans1 = exo4_meth1(ch1, 5);
    ans2 = exo4_meth1(ch1, 5);
    ...
    char *ch2 = "malayalam";
    ans1 = exo4_meth1(ch2, 9);
    ans2 = exo4_meth2(ch2, 9);
    if (ans1 != TRUE || ans2 != TRUE)  return EXIT_FAILURE;



    char *ch3 = "nanan";
    ans1 = exo4_meth1(ch3, 5);
    ans2 = exo4_meth2(ch3, 5);
    if (ans1 != TRUE || ans2 != TRUE)  return EXIT_FAILURE;



    char *ch4 = "ressasser";
    ans1 = exo4_meth1(ch4, 9);
    ans2 = exo4_meth2(ch4, 9);

    if (ans1 != TRUE || ans2 != TRUE)  return EXIT_FAILURE;


    char *ch5 = "motnonpalindrome";
    ans1 = exo4_meth1(ch5, 16);
    ans2 = exo4_meth2(ch5, 16);
